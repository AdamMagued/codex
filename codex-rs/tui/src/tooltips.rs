...
const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'kimcli app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'kimcli app' or visit https://chatgpt.com/codex?app-landing-page=true";
