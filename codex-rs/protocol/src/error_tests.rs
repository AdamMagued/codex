...
fn usage_limit_reached_error_formats_plus_plan() {
    ...
    assert_eq!(
        err.to_string(),
        "You've hit your usage limit. Upgrade to Pro or purchase more credits from your ChatGPT plan settings or try again later."
    );
}
...
fn usage_limit_reached_error_formats_free_plan() {
    ...
    assert_eq!(
        err.to_string(),
        "You've hit your usage limit. Upgrade to Plus to continue using Kim, or try again later."
    );
}
...
fn usage_limit_reached_error_formats_pro_plan_with_reset() {
    ...
    with_now_override(base, move || {
        ...
        let expected = format!(
            "You've hit your usage limit. Purchase more credits from your ChatGPT plan settings or try again at {expected_time}."
        );
        assert_eq!(err.to_string(), expected);
    });
}
...
fn usage_limit_reached_error_hides_upsell_for_non_codex_limit_name() {
    ...
    with_now_override(base, move || {
        ...
        let err = UsageLimitReachedError {
            ...
            promo_message: Some(
                "Purchase more credits from your ChatGPT plan settings"
                    .to_string(),
            ),
            rate_limit_reached_type: None,
        };
...
fn usage_limit_reached_includes_hours_and_minutes() {
    ...
    with_now_override(base, move || {
        ...
        let expected = format!(
            "You've hit your usage limit. Upgrade to Pro or purchase more credits from your ChatGPT plan settings or try again at {expected_time}."
        );
        assert_eq!(err.to_string(), expected);
    });
}
